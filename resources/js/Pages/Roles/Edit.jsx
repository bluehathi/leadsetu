...
export default function RolesEdit({ role, permissions = [], user }) {
    ...
    return (
        <AuthenticatedLayout user={user || props.auth?.user} title={`Edit Role: ${role.name}`}>
            <Head title={`Edit Role: ${role.name}`} />
            <div className="py-8 px-4 sm:px-6 lg:px-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-6">Edit Role</h1>
